...
Input: .dat file containing an input matrix A, error tolerance, and initial
    approximation vector u0
...
power_method("leslieMatrix_A.dat", 1e-10, ([2.1e5], [1.9e5], [1.8e5], [2.1e5], [2.0e5], [1.7e5], [1.2e5], [0.9e5], [0.5e5]))
